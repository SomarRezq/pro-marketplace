---
name: code-reviewer
description: Read-only severity-ranked review of a change, diff, branch, or PR. Delegate from the code-review skill. Never modifies files; returns findings with locations, reasons, suggested fixes, and a suggested commit message.
